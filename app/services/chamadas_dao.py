...
def buscar_nome_atendente(cur: psycopg.Cursor, ramal: int) -> str | None:
    ...
    cur.execute(
        ...
        (ramal,),   # A vírgula é obrigatória para criar uma tupla de um único elemento. Isso é usado pelo driver do banco para fazer a substituição parametrizada do %s. Apenas para o psycopg.
    )
